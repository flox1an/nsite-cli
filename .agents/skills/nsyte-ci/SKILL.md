---
name: nsyte-ci
description: Configures nsyte for non-interactive CI/CD deployment using environment variable authentication and the --non-interactive flag. Use when the user wants to automate nsyte deploys in a CI pipeline, GitHub Actions, or any headless environment.
---
